...
export default function StrudelMusicSequencer() {
    ...
    return (
        <div>
            {/* preview */}
            <div className="w-[30vw] h-[70vh] flex flex-col items-center justify-center">
                <motion.div
                    className="w-[30vw] h-[40vh] flex items-center justify-center overflow-hidden"
                    layoutId="container"
                    layout
                ...
                <div className="w-full h-auto text-[0.7rem] font-light tracking-widest">
                ...
                <div className="fixed inset-0 z-[60] flex items-center justify-center">
                    ...
                    <div className="relative w-full min-h-full flex flex-row items-start justify-between px-[5vw]">
                        ...
                        >
                            ...
                            {/* title */}
                            <div className="flex flex-row items-baseline justify-between select-none">
                            ...
                            <div className="w-[50vw] flex flex-col items-center justify-center px-[2vw] border-t border-b border-white/60">
                                <div className="w-full flex flex-row items-start justify-between border-b border-white/40 py-5">
                                    <h4 className="text-[0.8rem] font-bold">TECHNOLOGIES</h4>
                                ...
                                <div className="w-full flex flex-row items-start justify-between border-b border-white/40 py-5">
                                    <h4 className="text-[0.8rem] font-bold">DURATION</h4>
                                ...
                                <div className="w-full flex flex-row items-start justify-between py-5">
                                    <h4 className="text-[0.8rem] font-bold">SUMMARY</h4>
