                            ...
                            <div className="w-[50vw] flex flex-col items-center justify-center px-[2vw] border-t border-b border-white/60">
                                <div className="w-full flex flex-row items-start justify-between border-b border-white/40 py-5">
                                    ...
                                    <div className="w-[60%] text-[0.7rem] font-light flex flex-wrap justify-end">
                                        <p className="w-fit h-fit p-1 px-5 m-1 border border-white rounded-full">WordPress</p>
                                        <p className="w-fit h-fit p-1 px-5 m-1 border border-white rounded-full">CSS</p>
                                        <p className="w-fit h-fit p-1 px-5 m-1 border border-white rounded-full">JavaScript</p>
                                        <p className="w-fit h-fit p-1 px-5 m-1 border border-white rounded-full">MySQL</p>
                                ...
                                <div className="w-full flex flex-row items-start justify-between py-5">
                                    ...
                                    <div className="w-[60%] text-[0.8rem] font-light">
                                        <p>
                                            My first portfolio, built with WordPress, CSS, and JavaScript. This project marked my first exploration into web interactivity, featuring SVG animations and scroll-driven effects.  
                                            It is a foundational milestone where I began blending technical logic with visual motion, setting the stage for my evolution into creative development.
                                        </p>
                                    </div>
